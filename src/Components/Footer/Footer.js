          ...
          <div className="row">
            <div className="col-12 col-md-6 col-lg-3">
              <div className="kilimanjaro_part">
                <h5>About Us</h5>
                <p>
                  It includes rich features &amp; contents. It's designed &amp; developed based on
                  One Page/ Multi-page Layout,blog themes,world press themes and blogspot.
                </p>
              </div>
            ...
            <div className="col-12 col-md-6 col-lg-3">
              <div className="kilimanjaro_part">
                ...
                <div className="kilimanjaro_single_contact_info">
                  <h5>Phone:</h5>
                  <p>
                    +91 92933 93xxx <br /> +91 88392 84xxx
                  </p>
                </div>
                <div className="kilimanjaro_single_contact_info">
                  <h5>Email:</h5>
                  <p>
                    laurel.v19@iiits.in <br /> 1laurelverma@gmail.com
                  </p>
                </div>
              </div>
              <div className="kilimanjaro_part"></div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="container">
          <div className="row">
            <div className="col-12">
              <p>© All Rights Reserved by NewsToday</p>
            </div>
          </div>
        </div>
      </div>
