...
const Signup = () => {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      const upload = await axios.post(`${process.env.REACT_APP_SERVER}/upload`, formData);
      ...
      const response = await axios.post(`${process.env.REACT_APP_SERVER}/user/signup`, data, {
        headers: {
          ...
          <form id="signupForm" onSubmit={onSubmit} encType="multipart/form-data">
            ...
            <div className="row">
              <div className="col-12">
                <button type="submit" className="click-button registerbutton" id="register-button">
                  Register
                </button>
