...
const ArticleOpen = () => {
  ...
  const { value1, value2, value3, value4, value5, value6 } = React.useContext(NewsContext);
  ...
  const showdata = (category) => {
    if (category === "general") {
      ...
      return (
        <div className="container wrapper">
          <img className="responsiv-img" alt="" src={generalCards[params.index].urlToImage}></img>
          ...
          <p className="entry-content">
            ...
            <a href={generalCards[params.index].url} className="url">
              READ FULL ARTICLE
            </a>
          </p>
    ...
    if (category === "sports") {
      return (
        <div className="container wrapper">
          <img className="responsiv-img" alt="" src={sportCards[params.index].urlToImage}></img>
          ...
          <p className="entry-content">
            ...
            <a href={sportCards[params.index].url} className="url">
              READ FULL ARTICLE
            </a>
          </p>
    ...
    if (category === "entertainment") {
      return (
        <div className="container wrapper">
          <img className="responsiv-img" alt="" src={entertainCards[params.index].urlToImage}></img>
          ...
          <p className="entry-content">
            ...
            <a href={entertainCards[params.index].url} className="url">
              READ FULL ARTICLE
            </a>
          </p>
    ...
    if (category === "technology") {
      return (
        <div className="container wrapper">
          <img className="responsiv-img" alt="" src={techCards[params.index].urlToImage}></img>
          ...
          <p className="entry-content">
            ...
            <a href={techCards[params.index].url} className="url">
              READ FULL ARTICLE
            </a>
          </p>
    ...
    if (category === "business") {
      return (
        <div className="container wrapper">
          <img className="responsiv-img" alt="" src={businessCards[params.index].urlToImage}></img>
          ...
          <p className="entry-content">
            ...
            <a href={businessCards[params.index].url} className="url">
              READ FULL ARTICLE
            </a>
          </p>
    ...
    if (category === "health") {
      return (
        <div className="container wrapper">
          <img className="responsiv-img" alt="" src={healthCards[params.index].urlToImage}></img>
          ...
          <p className="entry-content">
            ...
            <a href={healthCards[params.index].url} className="url">
              READ FULL ARTICLE
            </a>
          </p>
